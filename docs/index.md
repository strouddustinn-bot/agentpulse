...
description: "The accepted AgentPulse prerelease supports bounded, policy-approved local responses and verification; public onboarding remains closed."
---

<section class="hero section-pad">
  <div class="hero-copy reveal is-visible">
    <div class="eyebrow"><span class="live-dot"></span> Accepted prerelease · Onboarding closed</div>
    <h1>Your servers don’t need <em>another dashboard.</em></h1>
    <p class="hero-lede">The accepted prerelease detects repeat host incidents, prepares a bounded response, checks local policy, and verifies permitted actions. Public onboarding remains closed.</p>
    <div class="hero-actions">
      <a class="button button-primary" href="signup#reserve"><span>Request pilot consideration</span><span aria-hidden="true">↗</span></a>
...
<section class="thesis section-pad reveal">
  ...
  <div class="thesis-grid">
    <h2>Monitoring sees the fire.<br><span>The accepted artifact can handle a configured first move.</span></h2>
    <div>
      ...
      <p>The accepted artifact is deliberately narrower: repeat host incidents, explicit authority, deterministic safety gates, and verification after every permitted action. Access remains gated.</p>
    </div>
  </div>
</section>
...
<section class="system-section section-pad reveal">
  <div class="system-intro">
    ...
    <p>The hosted design allows cloud policy only to narrow local authority, never widen it. Public hosted activation is not deployed.</p>
  ...
  <div class="system-map">
    ...
    <div class="map-node map-cloud"><span>CLOUD · SOURCE ONLY</span><strong>Fleet evidence</strong><small>Public deployment pending</small></div>
...
<section class="plans section-pad reveal">
  <div class="plans-copy">
    ...
    <p>After staging passes, each invited pilot begins on one approved non-critical host in alert-only mode. Multi-host plans remain founding reservations until the three-to-five-customer controlled pilot proves the full paid lifecycle.</p>
    <a class="button button-primary" href="signup#reserve"><span>Request pilot consideration</span><span>↗</span></a>
  </div>
  <div class="plan-ledger">
    <div class="plan-row"><div><span>STARTER</span><strong>Post-staging pilot</strong></div><div><strong>C$29</strong><span>/ month CAD</span></div><p>One invited host · alert-only first</p></div>
    ...
    <div class="plan-row"><div><span>BUSINESS · FOUNDING</span><strong>Managed small fleet</strong></div><div><strong>C$299</strong><span>/ month CAD</span></div><p>Up to 20 hosts · priority support · guided onboarding</p></div>
